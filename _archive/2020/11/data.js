export const data = [
  ...
  /*
   sw: NullSpace { state: null, row: null, col: null, next: null, prev: null },
   s: NullSpace { state: null, row: null, col: null, next: null, prev: null },
   se: NullSpace { state: null, row: null, col: null, next: null, prev: null },
   e: Seat { state: '#', row: 0, col: 3, next: '#', prev: 'L' },
   ne: Seat { state: '#', row: 1, col: 3, next: '#', prev: 'L' },
   n: Seat { state: '#', row: 1, col: 2, next: '#', prev: 'L' },
   nw: Seat { state: '#', row: 1, col: 1, next: '#', prev: 'L' },
   w: NullSpace { state: null, row: null, col: null, next: null, prev: null }
